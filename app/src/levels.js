...
export const levels = [
  { 
      id: 1, 
      goal: "Найдите шкаф, к которому нельзя подойти, — из-за него маршрут делает петлю.",
  ...
  { 
      id: 2, 
      goal: "Найдите шкаф, у которого сторона подхода повёрнута не в ту сторону.",
  ...
  { 
      id: 3, 
      goal: "Выделите всю стену из шкафов целиком — все 17, — чтобы на её месте открылся проход.",
      complaint: "Чтобы попасть в соседний проход, я каждый раз иду вдоль всей стены до самого её края. Неужели нельзя пройти насквозь?", 
      successMessage: "Отлично! Убрав эту стену, мы создадим короткий проход.",
      hintText: "Длинная стена из шкафов делит склад пополам, и прохода в ней нет ни одного. Нужна вся стена целиком, сверху донизу: 17 шкафов в одной колонне, а не пара штук из середины.",
      hintZone: { x: 57.2, y: -0.5, w: 2.6, h: 30 },
  ...
  { 
      id: 4, 
      goal: "Найдите шкаф, к которому приходится подходить с обратной стороны.",
      complaint: "К одному стеллажу я захожу с дальней стороны: товар прямо передо мной, а чтобы его взять, надо обойти весь ряд.", 
  ...
  { 
      id: 5, 
      goal: "Найдите глухие блоки, о которых система не знает.",
      complaint: "Система провела меня прямо сквозь стену из шкафов, будто её там нет.", 
      successMessage: "Отличная работа! Вы правильно определили шкафы, из-за которых сборщику приходится делать крюк.",
      hintText: "Маршрут проходит прямо сквозь стену из шкафов. Система не знает, что там стоят глухие блоки — заштрихованные, без розовой грани подхода.",
